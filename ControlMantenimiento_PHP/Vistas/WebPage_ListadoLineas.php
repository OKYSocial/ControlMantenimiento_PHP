      ...
      <?php
           ...
           {  
                ...
                if (filter_input(INPUT_POST, 'itBusqueda')!='')
                {
                  ...
                  header("Location: ../Vistas/WebPage_ListadoLineas.php?Buscar=$DatoBuscar");                 
                }                  
                else
                {    
...
<body>     
      ...
      <form name="WebPage_ListadoLineas" action="WebPage_ListadoLineas.php" method="post">
		...
		<br/>
                ...
                <table width="55%" align="center" border="1" cellspacing="0" cellpadding="6">
                    ...
                    <tr>
                        <td align="center" width="55%"  bgcolor="teal"><label class="titulos">Lineas&nbsp;<i class="fa fa-list"></i></label></td>             
                    </tr>
